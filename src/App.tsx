...
export default function App() {
  ...
  const handleAddWater = (amount: number) => {
    ...
    // (Debounced trigger or simple threshold)
    if (Math.random() > 0.4) {
  ...
  return (
    <div className="bg-gradient-to-tr from-slate-50 via-slate-100/50 to-sky-50/40 min-h-screen font-sans">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 relative z-10">
        ...
        <main className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <section id="controls-panel" className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* Cell 2: Gemini Coach speach bubble */}
            <div className="md:col-span-1 h-full">
              <CoachBubble
                mode={coachMode}
                tip={currentTip}
            ...
            {/* Cell 3: Log intake details with quick buttons & manual entry (Spans full right width) */}
        ...
        <footer className="mt-12 text-center text-[11px] text-slate-400 font-sans max-w-xl mx-auto border-t border-slate-200/50 pt-6">
          ...
          <p className="mt-1">
            Powered by modern full-stack Node.js server, React, Vite, and Gemini AI.
          </p>
        </footer>
